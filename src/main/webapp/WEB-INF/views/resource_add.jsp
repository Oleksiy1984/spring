	...
	<form:form action="${formUrl}" method="POST" modelAttribute="resource">
		...
		<div class="row">
			...
			<div class="form-group">
				...
				<form:select path="type" id="resource-type" items="${typeOptions}" cssClass="selectpicker"/>

			</div>

			<div class="form-group">
				<label for="cost">Cost</label> <input id="cost" type="text" cssClass="form-control" name="cost" />
			</div>
